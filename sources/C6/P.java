...
public final class P extends j0 implements y6.b {

    /* renamed from: c, reason: collision with root package name */
    public static final P f1018c = new P();

    private P() {
        super(AbstractC4273a.B(kotlin.jvm.internal.A.f34566a));
    }
    ...
    public void m(B6.c decoder, int i8, O builder, boolean z8) {
    ...
    public void z(B6.d encoder, long[] content, int i8) {
