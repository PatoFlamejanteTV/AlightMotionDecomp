...
public final class p extends AbstractC2983a implements Serializable {

    /* renamed from: o, reason: collision with root package name */
    public static final p f32851o;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: d, reason: collision with root package name */
    private final transient String f32852d = "Hijrah-umalqura";

    /* renamed from: e, reason: collision with root package name */
    private final transient String f32853e = LocalePreferences.CalendarType.ISLAMIC_UMALQURA;

    /* renamed from: f, reason: collision with root package name */
    private volatile transient boolean f32854f;

    /* renamed from: g, reason: collision with root package name */
    private transient int[] f32855g;

    /* renamed from: h, reason: collision with root package name */
    private transient int f32856h;

    /* renamed from: i, reason: collision with root package name */
    private transient int f32857i;
    ...
    private transient int f32860l;

    /* renamed from: m, reason: collision with root package name */
    private transient int f32861m;
    ...
    static {
        p pVar = new p();
        f32851o = pVar;
        AbstractC2983a.l(pVar, "Hijrah");
        AbstractC2983a.l(pVar, LocalePreferences.CalendarType.ISLAMIC);
    }
    ...
    private void m() {
        ...
        try {
            ...
            if (!this.f32853e.equals(LocalePreferences.CalendarType.ISLAMIC_UMALQURA)) {
            ...
            int[] u8 = u(s8, hashMap);
            this.f32855g = u8;
            this.f32857i = u8[3612];
            for (int i9 = 1300; i9 < 1600; i9++) {
                int i10 = (i9 * 12) - this.f32858j;
                int[] iArr2 = this.f32855g;
                int i11 = iArr2[i10 + 12] - iArr2[i10];
                this.f32861m = Math.min(this.f32861m, i11);
                this.f32862n = Math.max(this.f32862n, i11);
            }
            this.f32854f = true;
        } catch (Exception e8) {
    ...
    private int[] u(int i8, HashMap hashMap) {
        ...
        this.f32859k = Integer.MAX_VALUE;
        this.f32860l = Integer.MIN_VALUE;
        int i9 = 0;
        for (int i10 = 1300; i10 <= 1600; i10++) {
            ...
            while (i11 < 12) {
                ...
                i8 += i12;
                this.f32859k = Math.min(this.f32859k, i12);
                this.f32860l = Math.max(this.f32860l, i12);
                i11++;
                i9 = i13;
            }
        }
    ...
    public final int[] D(int i8) {
        m();
        if (i8 < this.f32856h || i8 >= this.f32857i) {
            throw new RuntimeException("Hijrah date out of range");
        }
        int binarySearch = Arrays.binarySearch(this.f32855g, i8);
        if (binarySearch < 0) {
            binarySearch = (-binarySearch) - 2;
        }
        int i9 = this.f32858j;
        return new int[]{(binarySearch + i9) / 12, ((i9 + binarySearch) % 12) + 1, (i8 - this.f32855g[binarySearch]) + 1};
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final int E(int i8, int i9) {
        int i10 = (i9 - 1) + ((i8 * 12) - this.f32858j);
        if (i10 >= 0) {
            int[] iArr = this.f32855g;
            if (i10 < iArr.length) {
    ...
    public final j$.time.temporal.w H(j$.time.temporal.a aVar) {
        ...
        switch (o.f32850a[aVar.ordinal()]) {
            case 1:
                return j$.time.temporal.w.k(this.f32859k, this.f32860l);
            case 2:
                return j$.time.temporal.w.j(1L, this.f32862n);
            case 3:
                return j$.time.temporal.w.j(1L, 5L);
            case 4:
            case 5:
                int i8 = this.f32858j;
                return j$.time.temporal.w.j(i8 / 12, (((this.f32855g.length - 1) + i8) / 12) - 1);
            case 6:
    ...
    public final int r(long j8) {
        int i8 = this.f32858j;
        if (j8 >= i8 / 12 && j8 <= (((this.f32855g.length - 1) + i8) / 12) - 1) {
            return (int) j8;
        }
    ...
    public final long z(int i8, int i9, int i10) {
        ...
        int i11 = (i9 - 1) + ((i8 * 12) - this.f32858j);
        if (i11 < 0 || i11 >= this.f32855g.length) {
            throw new RuntimeException("Invalid Hijrah date, year: " + i8 + ", month: " + i9);
        }
        if (i10 >= 1 && i10 <= E(i8, i9)) {
            return (i10 - 1) + this.f32855g[i11];
        }
