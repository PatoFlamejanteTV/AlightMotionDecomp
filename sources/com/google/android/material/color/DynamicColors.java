...
public class DynamicColors {
        ...
        if (isDynamicColorAvailable()) {
            ...
            if (dynamicColorsOptions.getPrecondition().shouldApplyDynamicColors(activity, i8)) {
                if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
                    ...
                    ColorResourcesOverride a9 = i.a();
                    if (a9 == null || !a9.applyIfPossible(activity, MaterialColorUtilitiesHelper.createColorResourcesIdsToColorValues(schemeContent))) {
                        return;
                    }
                } else {
    ...
    public static Context wrapContextIfAvailable(@NonNull Context context, @NonNull DynamicColorsOptions dynamicColorsOptions) {
        ...
        if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
            ...
            ColorResourcesOverride a9 = i.a();
            if (a9 != null) {
                return a9.wrapContextIfPossible(context, MaterialColorUtilitiesHelper.createColorResourcesIdsToColorValues(schemeContent));
            }
        }
