...
public class a {
    ...
    public final String b() {
        try {
            if (TextUtils.isEmpty(this.f19177c)) {
                this.f19177c = c();
            }
            if (TextUtils.isEmpty(this.f19177c)) {
                g b9 = h.a().b(com.mbridge.msdk.foundation.controller.c.m().k());
                if (b9 != null && !TextUtils.isEmpty(b9.T())) {
                    a(com.mbridge.msdk.foundation.controller.c.m().c(), b9.T());
                }
                return f19175a;
            }
            return this.f19177c;
    ...
    public final void a(Context context, final String str) {
        ...
        String a9 = com.mbridge.msdk.foundation.a.a.a.a().a("MraidJSController");
        if (TextUtils.isEmpty(a9) || !a9.equals(str)) {
            try {
