...
public final class MenuKt$DropdownMenuContent$2 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public MenuKt$DropdownMenuContent$2(Modifier modifier, InterfaceC2073o interfaceC2073o, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier verticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m579paddingVpY3zN4$default(this.$modifier, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), ScrollKt.rememberScrollState(0, composer, 0, 1), false, null, false, 14, null);
        ...
        InterfaceC2073o materializerOf = LayoutKt.materializerOf(verticalScroll$default);
