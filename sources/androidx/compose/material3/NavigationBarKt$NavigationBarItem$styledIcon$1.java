...
public final class NavigationBarKt$NavigationBarItem$styledIcon$1 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public NavigationBarKt$NavigationBarItem$styledIcon$1(NavigationBarItemColors navigationBarItemColors, boolean z8, int i8, InterfaceC2072n interfaceC2072n, boolean z9, InterfaceC2072n interfaceC2072n2) {
        super(2);
    ...
    private static final long m1686invoke$lambda0(State<Color> state) {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2938boximpl(m1686invoke$lambda0(iconColor$material3_release)))}, interfaceC2072n, composer, ((i10 >> 6) & 112) | 8);
