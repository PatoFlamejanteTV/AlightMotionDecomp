...
public final class ProgressIndicatorKt$CircularProgressIndicator$2 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public final void invoke(Composer composer, int i8) {
        ProgressIndicatorKt.m1716CircularProgressIndicatorMBs18nI(this.$progress, this.$modifier, this.$color, this.$strokeWidth, composer, this.$$changed | 1, this.$$default);
    }
}
