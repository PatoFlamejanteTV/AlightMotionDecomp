...
public final class SliderKt$sliderTapModifier$2 extends AbstractC3293z implements InterfaceC2073o {
    ...
    public static final class AnonymousClass1 extends l implements InterfaceC2072n {
        ...
        /* loaded from: classes.dex */
        public static final class C03491 extends l implements InterfaceC2073o {
            final /* synthetic */ boolean $isRtl;
            final /* synthetic */ int $maxPx;
            final /* synthetic */ MutableState<Float> $pressOffset;
            final /* synthetic */ State<Float> $rawOffset;
            ...
            C03491(boolean z8, int i8, MutableState<Float> mutableState, State<Float> state, d dVar) {
                super(3, dVar);
                this.$isRtl = z8;
                this.$maxPx = i8;
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
                return m1743invoked4ec7I((PressGestureScope) obj, ((Offset) obj2).m2722unboximpl(), (d) obj3);
            }

            /* renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final Object m1743invoked4ec7I(PressGestureScope pressGestureScope, long j8, d dVar) {
                C03491 c03491 = new C03491(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, dVar);
                c03491.L$0 = pressGestureScope;
                c03491.J$0 = j8;
                return c03491.invokeSuspend(I.f8786a);
            }
        ...
        public static final class AnonymousClass2 extends AbstractC3293z implements Function1 {
            ...
            /* loaded from: classes.dex */
            public static final class C03501 extends l implements InterfaceC2072n {
                final /* synthetic */ DraggableState $draggableState;
                final /* synthetic */ State<Function0> $gestureEndAction;
                int label;
                ...
                /* loaded from: classes.dex */
                public static final class C03511 extends l implements InterfaceC2072n {
                    private /* synthetic */ Object L$0;
                    int label;
                    ...
                    public final Object invoke(DragScope dragScope, d dVar) {
                        return ((C03511) create(dragScope, dVar)).invokeSuspend(I.f8786a);
                    }
                ...
                C03501(DraggableState draggableState, State<? extends Function0> state, d dVar) {
                    super(2, dVar);
                ...
                @Override // kotlin.coroutines.jvm.internal.a
                public final d create(Object obj, d dVar) {
                    return new C03501(this.$draggableState, this.$gestureEndAction, dVar);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i8 != 0) {
                        ...
                        C03511 c03511 = new C03511(null);
                        this.label = 1;
                        if (draggableState.drag(mutatePriority, c03511, this) == e8) {
                            return e8;
                        }
                    }
                ...
                public final Object invoke(M m8, d dVar) {
                    return ((C03501) create(m8, dVar)).invokeSuspend(I.f8786a);
                }
            }
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                m1744invokek4lQ0M(((Offset) obj).m2722unboximpl());
                return I.f8786a;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1744invokek4lQ0M(long j8) {
                AbstractC3462k.d(this.$scope, null, null, new C03501(this.$draggableState, this.$gestureEndAction, null), 3, null);
            }
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                C03491 c03491 = new C03491(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, null);
                AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.$scope, this.$draggableState, this.$gestureEndAction);
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, c03491, anonymousClass2, this, 3, null) == e8) {
                    return e8;
                }
            }
            return I.f8786a;
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        if (this.$enabled) {
            ...
            composer.endReplaceableGroup();
            composed = SuspendingPointerInputFilterKt.pointerInput(composed, new Object[]{this.$draggableState, this.$interactionSource, Integer.valueOf(this.$maxPx), Boolean.valueOf(this.$isRtl)}, (InterfaceC2072n) new AnonymousClass1(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, coroutineScope, this.$draggableState, this.$gestureEndAction, null));
        }
        if (ComposerKt.isTraceInProgress()) {
