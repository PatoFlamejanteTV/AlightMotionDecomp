...
final class ListItemKt$ListItem$6 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public ListItemKt$ListItem$6(float f8, PaddingValues paddingValues, InterfaceC2073o interfaceC2073o, int i8) {
        super(2);
        this.$minHeight = f8;
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier padding = PaddingKt.padding(SizeKt.m612heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, null), this.$paddingValues);
