...
public final class SliderKt$Slider$2$1 extends AbstractC3293z implements InterfaceC2073o {
    ...
    public final void invoke(SliderPositions it, Composer composer, int i8) {
        ...
        int i9 = this.$$dirty;
        sliderDefaults.m1734Thumb9LiSoMs(mutableInteractionSource, null, sliderColors, z8, 0L, composer, ((i9 >> 24) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | ((i9 >> 15) & 896) | (i9 & 7168), 18);
        if (ComposerKt.isTraceInProgress()) {
