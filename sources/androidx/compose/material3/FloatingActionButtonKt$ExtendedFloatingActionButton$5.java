...
public final class FloatingActionButtonKt$ExtendedFloatingActionButton$5 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public FloatingActionButtonKt$ExtendedFloatingActionButton$5(boolean z8, InterfaceC2072n interfaceC2072n, int i8, InterfaceC2072n interfaceC2072n2) {
        super(2);
        this.$expanded = z8;
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        float m2089getContainerWidthD9Ej5fM;
        ...
        if (this.$expanded) {
            m5155constructorimpl = FloatingActionButtonKt.ExtendedFabStartIconPadding;
        } else {
            m5155constructorimpl = Dp.m5155constructorimpl(0);
        }
        float f8 = m5155constructorimpl;
        if (this.$expanded) {
            m5155constructorimpl2 = FloatingActionButtonKt.ExtendedFabTextPadding;
        } else {
            m5155constructorimpl2 = Dp.m5155constructorimpl(0);
        }
        float f9 = m5155constructorimpl2;
        Modifier.Companion companion = Modifier.Companion;
        if (this.$expanded) {
            m2089getContainerWidthD9Ej5fM = FloatingActionButtonKt.ExtendedFabMinimumWidth;
        } else {
            m2089getContainerWidthD9Ej5fM = FabPrimaryTokens.INSTANCE.m2089getContainerWidthD9Ej5fM();
        }
        Modifier m581paddingqDBjuR0$default = PaddingKt.m581paddingqDBjuR0$default(SizeKt.m628sizeInqDBjuR0$default(companion, m2089getContainerWidthD9Ej5fM, 0.0f, 0.0f, 0.0f, 14, null), f8, 0.0f, f9, 0.0f, 10, null);
        ...
        interfaceC2072n.invoke(composer, Integer.valueOf((i9 >> 3) & 14));
        ...
        AnimatedVisibilityKt.AnimatedVisibility(rowScopeInstance, z8, (Modifier) null, enterTransition, exitTransition, (String) null, ComposableLambdaKt.composableLambda(composer, 176242764, true, new FloatingActionButtonKt$ExtendedFloatingActionButton$5$1$1(interfaceC2072n2, i9)), composer, 1600518 | ((i9 >> 9) & 112), 18);
