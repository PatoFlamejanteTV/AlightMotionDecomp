...
public final class TextFieldImplKt$CommonDecorationBox$3$borderContainerWithId$1 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public TextFieldImplKt$CommonDecorationBox$3$borderContainerWithId$1(MutableState<Size> mutableState, PaddingValues paddingValues, InterfaceC2072n interfaceC2072n, int i8) {
        super(2);
        this.$labelSize = mutableState;
        this.$contentPadding = paddingValues;
        this.$container = interfaceC2072n;
        this.$$dirty1 = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier m1714outlineCutout12SF9DM = OutlinedTextFieldKt.m1714outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId), this.$labelSize.getValue().m2786unboximpl(), this.$contentPadding);
        InterfaceC2072n interfaceC2072n = this.$container;
        int i9 = this.$$dirty1;
        ...
        InterfaceC2073o materializerOf = LayoutKt.materializerOf(m1714outlineCutout12SF9DM);
