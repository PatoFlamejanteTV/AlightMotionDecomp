...
public final class SnackbarHostKt {
    ...
    */
    public static final void FadeInFadeOutWithScale(androidx.compose.material3.SnackbarData r16, androidx.compose.ui.Modifier r17, c6.InterfaceC2073o r18, androidx.compose.runtime.Composer r19, int r20, int r21) {
        /*
            Method dump skipped, instructions count: 574
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SnackbarHostKt.FadeInFadeOutWithScale(androidx.compose.material3.SnackbarData, androidx.compose.ui.Modifier, c6.o, androidx.compose.runtime.Composer, int, int):void");
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable]]")
    public static final void SnackbarHost(SnackbarHostState hostState, Modifier modifier, InterfaceC2073o interfaceC2073o, Composer composer, int i8, int i9) {
        int i10;
        int i11;
        int i12;
        int i13;
        AbstractC3292y.i(hostState, "hostState");
        ...
        if ((i10 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (i15 != 0) {
                interfaceC2073o = ComposableSingletons$SnackbarHostKt.INSTANCE.m1566getLambda1$material3_release();
            }
            ...
            FadeInFadeOutWithScale(hostState.getCurrentSnackbarData(), modifier, interfaceC2073o, startRestartGroup, i10 & PointerIconCompat.TYPE_TEXT, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SnackbarHostKt$SnackbarHost$2(hostState, modifier2, interfaceC2073o2, i8, i9));
        }
    }
    ...
    public static final long toMillis(SnackbarDuration snackbarDuration, boolean z8, AccessibilityManager accessibilityManager) {
        long j8;
        AbstractC3292y.i(snackbarDuration, "<this>");
