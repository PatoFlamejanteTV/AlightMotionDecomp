...
public final class SurfaceKt$Surface$3 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public SurfaceKt$Surface$3(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, MutableInteractionSource mutableInteractionSource, boolean z8, Function0 function0, InterfaceC2072n interfaceC2072n, int i9) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        m1787surfaceColorAtElevationCLU3JFs = SurfaceKt.m1787surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 12) & 14);
        ...
        Modifier m290clickableO2vRcR0$default = ClickableKt.m290clickableO2vRcR0$default(m1786surface8ww4TTg, this.$interactionSource, RippleKt.m1421rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, Role.m4493boximpl(Role.Companion.m4500getButtono7Vup1c()), this.$onClick, 8, null);
        ...
        InterfaceC2073o materializerOf = LayoutKt.materializerOf(m290clickableO2vRcR0$default);
