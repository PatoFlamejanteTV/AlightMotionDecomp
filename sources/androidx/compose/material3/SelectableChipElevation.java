...
public final class SelectableChipElevation {
    ...
    public /* synthetic */ SelectableChipElevation(float f8, float f9, float f10, float f11, float f12, float f13, AbstractC3284p abstractC3284p) {
    ...
    private final State<Dp> animateElevation(boolean z8, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        if (!z8) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5153boximpl(f9), new SelectableChipElevation$animateElevation$2(animatable, f9, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-699481375);
            EffectsKt.LaunchedEffect(Dp.m5153boximpl(f9), new SelectableChipElevation$animateElevation$3(animatable, this, f9, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (Dp.m5160equalsimpl0(this.defaultElevation, selectableChipElevation.defaultElevation) && Dp.m5160equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m5160equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m5160equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m5160equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation)) {
            return true;
        }
        return false;
    }
