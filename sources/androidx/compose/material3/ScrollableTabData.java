...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i8, List<TabPosition> list) {
        int mo419roundToPx0680j_4 = density.mo419roundToPx0680j_4(((TabPosition) AbstractC1435t.y0(list)).m1808getRightD9Ej5fM()) + i8;
        int maxValue = mo419roundToPx0680j_4 - this.scrollState.getMaxValue();
        return m.k(density.mo419roundToPx0680j_4(tabPosition.m1807getLeftD9Ej5fM()) - ((maxValue / 2) - (density.mo419roundToPx0680j_4(tabPosition.m1809getWidthD9Ej5fM()) / 2)), 0, m.d(mo419roundToPx0680j_4 - maxValue, 0));
    }
