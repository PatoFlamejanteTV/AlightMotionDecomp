...
public final class ListItemKt$ListItem$4 extends AbstractC3293z implements InterfaceC2073o {
    ...
    public ListItemKt$ListItem$4(InterfaceC2072n interfaceC2072n, ListItemColors listItemColors, int i8, InterfaceC2072n interfaceC2072n2, InterfaceC2072n interfaceC2072n3, InterfaceC2072n interfaceC2072n4, InterfaceC2072n interfaceC2072n5) {
        super(3);
    ...
    public final void invoke(RowScope ListItem, Composer composer, int i8) {
        ...
        if (interfaceC2072n != null) {
            m1664leadingContentiJQMabo = ListItemKt.m1664leadingContentiJQMabo(interfaceC2072n, this.$colors.leadingIconColor$material3_release(true, composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m2958unboximpl(), true, composer, ((this.$$dirty >> 12) & 14) | 384);
        ...
        Modifier m581paddingqDBjuR0$default = PaddingKt.m581paddingqDBjuR0$default(a9, 0.0f, 0.0f, f8, 0.0f, 11, null);
        ...
        int i11 = (i10 >> 18) & 14;
        long m2958unboximpl = listItemColors.overlineColor$material3_release(composer, i11).getValue().m2958unboximpl();
        ...
        ListItemKt.m1659ProvideTextStyleFromToken3JVO9M(listItemColors.supportingColor$material3_release(composer, i11).getValue().m2958unboximpl(), listTokens.getListItemSupportingTextFont(), interfaceC2072n4, composer, ((i10 >> 3) & 896) | 48);
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endNode();
        ...
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        InterfaceC2072n interfaceC2072n5 = this.$trailingContent;
        if (interfaceC2072n5 != null) {
            m1665trailingContentiJQMabo = ListItemKt.m1665trailingContentiJQMabo(interfaceC2072n5, this.$colors.trailingIconColor$material3_release(true, composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m2958unboximpl(), true, composer, ((this.$$dirty >> 15) & 14) | 384);
