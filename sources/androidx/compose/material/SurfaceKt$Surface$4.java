...
public final class SurfaceKt$Surface$4 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public SurfaceKt$Surface$4(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, MutableInteractionSource mutableInteractionSource, boolean z8, Function0 function0, InterfaceC2072n interfaceC2072n) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        m1337surfaceColorAtElevationcq6XJ1M = SurfaceKt.m1337surfaceColorAtElevationcq6XJ1M(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 12) & 14);
        ...
        Modifier m290clickableO2vRcR0$default = ClickableKt.m290clickableO2vRcR0$default(m1336surface8ww4TTg, this.$interactionSource, RippleKt.m1421rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, null, this.$onClick, 24, null);
        ...
        interfaceC2072n.invoke(composer, Integer.valueOf((i9 >> 27) & 14));
