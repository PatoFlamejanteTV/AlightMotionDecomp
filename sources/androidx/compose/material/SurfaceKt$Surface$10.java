...
public final class SurfaceKt$Surface$10 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public SurfaceKt$Surface$10(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, boolean z8, MutableInteractionSource mutableInteractionSource, boolean z9, Function1 function1, InterfaceC2072n interfaceC2072n, int i9) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        m1337surfaceColorAtElevationcq6XJ1M = SurfaceKt.m1337surfaceColorAtElevationcq6XJ1M(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 15) & 14);
        ...
        Modifier m804toggleableO2vRcR0$default = ToggleableKt.m804toggleableO2vRcR0$default(m1336surface8ww4TTg, this.$checked, this.$interactionSource, RippleKt.m1421rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, this.$onCheckedChange, 16, null);
        ...
        InterfaceC2073o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m804toggleableO2vRcR0$default);
