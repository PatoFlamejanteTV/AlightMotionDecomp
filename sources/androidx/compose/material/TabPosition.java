...
public final class TabPosition {
    ...
    public final float m1352getLeftD9Ej5fM() {
        return this.left;
    }

    /* renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m1353getRightD9Ej5fM() {
        return Dp.m5155constructorimpl(this.left + this.width);
    }

    /* renamed from: getWidth-D9Ej5fM, reason: not valid java name */
    public final float m1354getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m5166toStringimpl(this.left)) + ", right=" + ((Object) Dp.m5166toStringimpl(m1353getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m5166toStringimpl(this.width)) + ')';
    }
