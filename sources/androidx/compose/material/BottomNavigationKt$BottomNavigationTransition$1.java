...
public final class BottomNavigationKt$BottomNavigationTransition$1 extends AbstractC3293z implements InterfaceC2072n {
    ...
    public BottomNavigationKt$BottomNavigationTransition$1(InterfaceC2073o interfaceC2073o, int i8, State<Float> state) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        interfaceC2073o.invoke(Float.valueOf(BottomNavigationTransition_Klgx_Pg$lambda$3), composer, Integer.valueOf((this.$$dirty >> 6) & 112));
        if (ComposerKt.isTraceInProgress()) {
