...
public final class LazyDslKt$items$4 extends AbstractC3293z implements InterfaceC2074p {
    final /* synthetic */ InterfaceC2074p $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyDslKt$items$4(InterfaceC2074p interfaceC2074p, List<? extends T> list) {
        super(4);
