...
public final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public HorizontalScrollLayoutModifier(TextFieldScrollerPosition scrollerPosition, int i8, TransformedText transformedText, Function0 textLayoutResultProvider) {
        AbstractC3292y.i(scrollerPosition, "scrollerPosition");
        AbstractC3292y.i(transformedText, "transformedText");
        AbstractC3292y.i(textLayoutResultProvider, "textLayoutResultProvider");
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3292y.d(this.scrollerPosition, horizontalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == horizontalScrollLayoutModifier.cursorOffset && AbstractC3292y.d(this.transformedText, horizontalScrollLayoutModifier.transformedText) && AbstractC3292y.d(this.textLayoutResultProvider, horizontalScrollLayoutModifier.textLayoutResultProvider);
    }
    ...
    public MeasureResult mo133measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        if (measurable.maxIntrinsicWidth(Constraints.m5122getMaxHeightimpl(j8)) < Constraints.m5123getMaxWidthimpl(j8)) {
            m5114copyZbe2FdA$default = j8;
        } else {
            m5114copyZbe2FdA$default = Constraints.m5114copyZbe2FdA$default(j8, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        Placeable mo4108measureBRTryo0 = measurable.mo4108measureBRTryo0(m5114copyZbe2FdA$default);
        int min = Math.min(mo4108measureBRTryo0.getWidth(), Constraints.m5123getMaxWidthimpl(j8));
        return MeasureScope.CC.q(measure, min, mo4108measureBRTryo0.getHeight(), null, new HorizontalScrollLayoutModifier$measure$1(measure, this, mo4108measureBRTryo0, min), 4, null);
    }
