...
public final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends AbstractC3293z implements InterfaceC2073o {
    ...
    public static final class AnonymousClass1 extends AbstractC3293z implements Function0 {
        ...
        public /* bridge */ /* synthetic */ Object invoke() {
            return Offset.m2701boximpl(m1067invokeF1C5BW0());
        }

        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
        public final long m1067invokeF1C5BW0() {
            return TextFieldSelectionManagerKt.m1066calculateSelectionMagnifierCenterAndroidO0kMr_c(this.$manager, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$1(this.$magnifierSize$delegate));
        }
    }
    ...
    public static final long invoke$lambda$1(MutableState<IntSize> mutableState) {
        return mutableState.getValue().m5325unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invoke$lambda$2(MutableState<IntSize> mutableState, long j8) {
        mutableState.setValue(IntSize.m5313boximpl(j8));
    }
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        if (rememberedValue == companion.getEmpty()) {
            rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5313boximpl(IntSize.Companion.m5326getZeroYbymL2g()), null, 2, null);
