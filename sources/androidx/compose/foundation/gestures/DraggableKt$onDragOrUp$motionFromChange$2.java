...
final class DraggableKt$onDragOrUp$motionFromChange$2 extends AbstractC3293z implements Function1 {
    ...
    public final Float invoke(PointerInputChange it) {
        ...
        return Float.valueOf(Offset.m2712getXimpl(PointerEventKt.positionChangeIgnoreConsumed(it)));
    }
}
