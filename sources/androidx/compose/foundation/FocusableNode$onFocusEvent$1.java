...
final class FocusableNode$onFocusEvent$1 extends l implements InterfaceC2072n {
    int label;
    ...
    public final Object invoke(M m8, d dVar) {
        return ((FocusableNode$onFocusEvent$1) create(m8, dVar)).invokeSuspend(I.f8786a);
    }
}
