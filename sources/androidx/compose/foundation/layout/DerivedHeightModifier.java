...
public final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    private final InterfaceC2072n heightCalc;
    private final WindowInsets insets;
    private final MutableState unconsumedInsets$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DerivedHeightModifier(WindowInsets insets, Function1 inspectorInfo, InterfaceC2072n heightCalc) {
        super(inspectorInfo);
        MutableState mutableStateOf$default;
        AbstractC3292y.i(insets, "insets");
        AbstractC3292y.i(inspectorInfo, "inspectorInfo");
        AbstractC3292y.i(heightCalc, "heightCalc");
        this.insets = insets;
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3292y.d(this.insets, derivedHeightModifier.insets) && AbstractC3292y.d(this.heightCalc, derivedHeightModifier.heightCalc)) {
            return true;
        }
        return false;
    }
    ...
    public MeasureResult mo133measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        Placeable mo4108measureBRTryo0 = measurable.mo4108measureBRTryo0(Constraints.m5114copyZbe2FdA$default(j8, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.CC.q(measure, mo4108measureBRTryo0.getWidth(), intValue, null, new DerivedHeightModifier$measure$2(mo4108measureBRTryo0), 4, null);
    }
