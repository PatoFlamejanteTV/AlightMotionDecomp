...
final class PaddingKt$padding$1 extends AbstractC3293z implements Function1 {
    ...
    public final void invoke(InspectorInfo $receiver) {
        ...
        $receiver.getProperties().set("start", Dp.m5153boximpl(this.$start));
        $receiver.getProperties().set("top", Dp.m5153boximpl(this.$top));
        $receiver.getProperties().set(TtmlNode.END, Dp.m5153boximpl(this.$end));
