...
public final class NodeCoordinator$hitNear$1 extends AbstractC3293z implements Function0 {
    ...
    public final void m4313invoke() {
        ...
        m4318nextUntilhw7D004 = NodeCoordinatorKt.m4318nextUntilhw7D004(this.$this_hitNear, this.$hitTestSource.mo4310entityTypeOLwlOKw(), NodeKind.m4320constructorimpl(2));
        nodeCoordinator.m4289hitNearJHbHoSQ(m4318nextUntilhw7D004, this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
