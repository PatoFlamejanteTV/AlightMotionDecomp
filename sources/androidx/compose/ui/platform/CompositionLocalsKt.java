...
public final class CompositionLocalsKt {
    ...
    public static final void ProvideCommonCompositionLocals(Owner owner, UriHandler uriHandler, InterfaceC2072n interfaceC2072n, Composer composer, int i8) {
        int i9;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            interfaceC2072n2 = interfaceC2072n;
            composer2 = startRestartGroup;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, interfaceC2072n2, composer2, ((i9 >> 3) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CompositionLocalsKt$ProvideCommonCompositionLocals$1(owner, uriHandler, interfaceC2072n2, i8));
        }
    }
