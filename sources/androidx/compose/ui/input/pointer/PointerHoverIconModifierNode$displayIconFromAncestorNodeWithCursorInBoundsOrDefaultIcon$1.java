...
public final class PointerHoverIconModifierNode$displayIconFromAncestorNodeWithCursorInBoundsOrDefaultIcon$1 extends AbstractC3293z implements Function1 {
    ...
    public final Boolean invoke(PointerHoverIconModifierNode pointerHoverIconModifierNode) {
        boolean z8;
        boolean z9;
        if (this.$pointerHoverIconModifierNode.f34573a == null) {
        ...
        if (this.$pointerHoverIconModifierNode.f34573a != null && pointerHoverIconModifierNode.getOverrideDescendants()) {
