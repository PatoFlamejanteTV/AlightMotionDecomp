...
public abstract class AbstractResolvableFuture<V> implements InterfaceFutureC4260d {
    ...
    public static final class SetFuture<V> implements Runnable {
        final InterfaceFutureC4260d future;
        final AbstractResolvableFuture<V> owner;

        SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, InterfaceFutureC4260d interfaceFutureC4260d) {
            this.owner = abstractResolvableFuture;
            this.future = interfaceFutureC4260d;
        }
    ...
    static Object getFutureValue(InterfaceFutureC4260d interfaceFutureC4260d) {
        if (interfaceFutureC4260d instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) interfaceFutureC4260d).value;
            if (obj instanceof Cancellation) {
        ...
        boolean isCancelled = interfaceFutureC4260d.isCancelled();
        if ((!GENERATE_CANCELLATION_CAUSES) & isCancelled) {
            return Cancellation.CAUSELESS_CANCELLED;
        }
        try {
            Object uninterruptibly = getUninterruptibly(interfaceFutureC4260d);
            ...
            if (!isCancelled) {
                return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + interfaceFutureC4260d, e8));
            }
        ...
        if (z9 | (obj instanceof SetFuture)) {
            ...
            while (true) {
                if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                    ...
                    InterfaceFutureC4260d interfaceFutureC4260d = ((SetFuture) obj).future;
                    if (interfaceFutureC4260d instanceof AbstractResolvableFuture) {
                        abstractResolvableFuture = (AbstractResolvableFuture) interfaceFutureC4260d;
                        ...
                        interfaceFutureC4260d.cancel(z8);
                        return true;
                    }
                } else {
                    obj = abstractResolvableFuture.value;
    ...
    public boolean setFuture(InterfaceFutureC4260d interfaceFutureC4260d) {
        Failure failure;
        checkNotNull(interfaceFutureC4260d);
        Object obj = this.value;
        if (obj == null) {
            if (interfaceFutureC4260d.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(interfaceFutureC4260d))) {
                    return false;
                }
                complete(this);
                return true;
            }
            SetFuture setFuture = new SetFuture(this, interfaceFutureC4260d);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    interfaceFutureC4260d.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            interfaceFutureC4260d.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
