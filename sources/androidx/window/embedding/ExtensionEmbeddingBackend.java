...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class Companion {
        ...
        private final EmbeddingInterfaceCompat initAndVerifyEmbeddingExtension() {
            ...
            try {
                ...
                Log.d(ExtensionEmbeddingBackend.TAG, AbstractC3292y.q("Failed to load embedding extension: ", th));
            }
        ...
        public final ExtensionEmbeddingBackend getInstance() {
            ...
            AbstractC3292y.f(extensionEmbeddingBackend);
    ...
    public final class EmbeddingCallbackImpl implements EmbeddingInterfaceCompat.EmbeddingCallbackInterface {
        ...
        public void onSplitInfoChanged(List<SplitInfo> splitInfo) {
            AbstractC3292y.i(splitInfo, "splitInfo");
    ...
    public static final class SplitListenerWrapper {
        ...
        public static final void m5455accept$lambda1(SplitListenerWrapper this$0, List splitsWithActivity) {
            AbstractC3292y.i(this$0, "this$0");
            AbstractC3292y.i(splitsWithActivity, "$splitsWithActivity");
        ...
        public final void accept(List<SplitInfo> splitInfoList) {
            ...
            if (AbstractC3292y.d(arrayList, this.lastValue)) {
                return;
            }
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.embedding.f
                ...
                public final void run() {
                    ExtensionEmbeddingBackend.SplitListenerWrapper.m5455accept$lambda1(ExtensionEmbeddingBackend.SplitListenerWrapper.this, arrayList);
                }
            });
        }
    ...
    public void registerSplitListenerForActivity(Activity activity, Executor executor, Consumer<List<SplitInfo>> callback) {
        ...
        try {
            if (getEmbeddingExtension() == null) {
                ...
                callback.accept(AbstractC1435t.m());
                return;
            }
            ...
            if (this.splitInfoEmbeddingCallback.getLastInfo() != null) {
                ...
                AbstractC3292y.f(lastInfo);
                splitListenerWrapper.accept(lastInfo);
            } else {
                splitListenerWrapper.accept(AbstractC1435t.m());
            }
            I i8 = I.f8786a;
        } finally {
            reentrantLock.unlock();
    ...
    public void unregisterSplitListenerForActivity(Consumer<List<SplitInfo>> consumer) {
        ...
        try {
            ...
            while (true) {
                ...
                if (AbstractC3292y.d(next.getCallback(), consumer)) {
