...
public abstract class ScatterMap<K, V> {
    ...
    /* loaded from: classes.dex */
    public class MapWrapper implements Map<K, V>, InterfaceC2767a, j$.util.Map {
        public MapWrapper() {
        }
    ...
    public /* synthetic */ ScatterMap(AbstractC3284p abstractC3284p) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(ScatterMap scatterMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, InterfaceC2072n interfaceC2072n, int i9, Object obj) {
        ...
        if (obj == null) {
            ...
            return scatterMap.joinToString(charSequence, charSequence5, charSequence6, i10, charSequence7, interfaceC2072n);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0070, code lost:            if (((r7 & ((~r7) << 6)) & (-9187201950435737472L)) == 0) goto L20;     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0072, code lost:            r11 = -1;     */
    /*
    ...
    */
    public final boolean contains(K r18) {
        ...
        L4a:
            ...
            r15 = r15[r11]
            boolean r15 = kotlin.jvm.internal.AbstractC3292y.d(r15, r1)
            if (r15 == 0) goto L63
            goto L73
        L63:
            r15 = 1
    ...
    */
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    int i9 = 8 - ((~(i8 - length)) >>> 31);
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128 && AbstractC3292y.d(v8, objArr[(i8 << 3) + i10])) {
                            return true;
                        }
                        j8 >>= 8;
                    }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            } else if (!AbstractC3292y.d(obj3, scatterMap.get(obj2))) {
                                return false;
                            }
                        }
                        j8 >>= 8;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x006b, code lost:            if (((r4 & ((~r4) << 6)) & (-9187201950435737472L)) == 0) goto L21;     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x006d, code lost:            r10 = -1;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final V get(K r14) {
        ...
        L45:
            ...
            r11 = r11[r10]
            boolean r11 = kotlin.jvm.internal.AbstractC3292y.d(r11, r14)
            if (r11 == 0) goto L5e
            goto L6e
        L5e:
            r10 = 1
    ...
    */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i8, CharSequence truncated, InterfaceC2072n interfaceC2072n) {
        Object[] objArr;
        Object[] objArr2;
        Object[] objArr3;
        Object[] objArr4;
                    ...
                    while (i13 < i12) {
                        if ((j8 & 255) < 128) {
                            ...
                            if (interfaceC2072n == null) {
                                ...
                                sb.append((CharSequence) interfaceC2072n.invoke(obj, obj2));
                            }
                            i10++;
                        } else {
                            objArr3 = objArr5;
