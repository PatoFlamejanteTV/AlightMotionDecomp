...
public abstract class IntObjectMap<V> {
    ...
    public /* synthetic */ IntObjectMap(AbstractC3284p abstractC3284p) {
        this();
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0064, code lost:            if (((r7 & ((~r7) << 6)) & (-9187201950435737472L)) == 0) goto L16;     */
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0066, code lost:            r11 = -1;     */
    /*
    ...
    */
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            } else if (!AbstractC3292y.d(obj2, intObjectMap.get(i12))) {
                                return false;
                            }
                        }
                        j8 >>= 8;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x005f, code lost:            if (((r4 & ((~r4) << 6)) & (-9187201950435737472L)) == 0) goto L17;     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0061, code lost:            r10 = -1;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, InterfaceC2072n transform, int i9, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
