...
public final class MutableIntObjectMap<V> extends IntObjectMap<V> {
    ...
    private final void resizeStorage(int i8) {
        ...
        while (i10 < i9) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                long j8 = i13 & ModuleDescriptor.MODULE_VERSION;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x005f, code lost:            if (((r4 & ((~r4) << 6)) & (-9187201950435737472L)) == 0) goto L18;     */
    ...
    */
    ...
    public /* synthetic */ MutableIntObjectMap(int i8, int i9, AbstractC3284p abstractC3284p) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0064, code lost:            if (((r7 & ((~r7) << 6)) & (-9187201950435737472L)) == 0) goto L19;     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0066, code lost:            r11 = -1;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
