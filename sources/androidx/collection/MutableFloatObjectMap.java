...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    private final void resizeStorage(int i8) {
        ...
        while (i10 < i9) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                long j8 = i11 & ModuleDescriptor.MODULE_VERSION;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0065, code lost:            if (((r4 & ((~r4) << 6)) & (-9187201950435737472L)) == 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0067, code lost:            r10 = -1;     */
    /*
    ...
    */
    ...
    public /* synthetic */ MutableFloatObjectMap(int i8, int i9, AbstractC3284p abstractC3284p) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0068, code lost:            if (((r6 & ((~r6) << 6)) & (-9187201950435737472L)) == 0) goto L19;     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x006a, code lost:            r10 = -1;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean remove(float r17, V r18) {
        ...
        L6b:
            ...
            r1 = r1[r10]
            r6 = r18
            boolean r1 = kotlin.jvm.internal.AbstractC3292y.d(r1, r6)
            if (r1 == 0) goto L7d
