...
public final class MutableIntSet extends IntSet {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x005f, code lost:            if (((r4 & ((~r4) << 6)) & (-9187201950435737472L)) == 0) goto L16;     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0064, code lost:            if (((r7 & ((~r7) << 6)) & (-9187201950435737472L)) == 0) goto L18;     */
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0066, code lost:            r11 = -1;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public /* synthetic */ MutableIntSet(int i8, int i9, AbstractC3284p abstractC3284p) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
