...
public abstract class MediaBrowserServiceCompat extends Service {
                ...
                public void run() {
                    if (!MediaBrowserServiceImplApi21.this.mRootExtrasList.isEmpty()) {
                        ...
                        if (f8 != null) {
                            ...
                            while (it.hasNext()) {
                                BundleCompat.putBinder(it.next(), MediaBrowserProtocol.EXTRA_SESSION_BINDER, f8.asBinder());
                            }
                        }
    ...
    private class ServiceBinderImpl {
        ...
        public void getMediaItem(final String str, final C2733b c2733b, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && c2733b != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.5
                    ...
                    public void run() {
                        ...
                        MediaBrowserServiceCompat.this.performLoadItem(str, connectionRecord, c2733b);
                    }
                });
            }
        }
        ...
        public void search(final String str, final Bundle bundle, final C2733b c2733b, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && c2733b != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.8
                    ...
                    public void run() {
                        ...
                        MediaBrowserServiceCompat.this.performSearch(str, bundle, connectionRecord, c2733b);
                    }
                });
            }
        }

        public void sendCustomAction(final String str, final Bundle bundle, final C2733b c2733b, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && c2733b != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                    ...
                    public void run() {
                        ...
                        MediaBrowserServiceCompat.this.performCustomAction(str, bundle, connectionRecord, c2733b);
                    }
                });
            }
        }
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (C2733b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (C2733b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (C2733b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final C2733b c2733b) {
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final C2733b c2733b) {
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final C2733b c2733b) {
