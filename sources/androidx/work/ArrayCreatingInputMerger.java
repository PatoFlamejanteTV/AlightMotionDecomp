...
public final class ArrayCreatingInputMerger extends InputMerger {
    private final Object concatenateArrayAndNonArray(Object obj, Object obj2, Class<?> cls) {
        ...
        AbstractC3292y.h(newArray, "newArray");
        return newArray;
    }
        ...
        while (it.hasNext()) {
            ...
            for (Map.Entry<String, Object> entry : keyValueMap.entrySet()) {
                ...
                if (obj == null) {
                    ...
                    if (AbstractC3292y.d(cls2, cls)) {
                        AbstractC3292y.h(value, "value");
                        value = concatenateArrays(obj, value);
                    } else if (AbstractC3292y.d(cls2.getComponentType(), cls)) {
                        value = concatenateArrayAndNonArray(obj, value, cls);
                    } else {
                        throw new IllegalArgumentException();
                    }
                }
                AbstractC3292y.h(value, "if (existingValue == nul…      }\n                }");
                hashMap.put(key, value);
            }
        }
        builder.putAll(hashMap);
        Data build = builder.build();
        AbstractC3292y.h(build, "output.build()");
        return build;
    }
}
