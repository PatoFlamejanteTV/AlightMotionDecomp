...
public abstract class AbstractFuture<V> implements InterfaceFutureC4260d {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        SetFuture(AbstractFuture<V> abstractFuture, InterfaceFutureC4260d interfaceFutureC4260d) {
    ...
    static Object getFutureValue(InterfaceFutureC4260d interfaceFutureC4260d) {
        if (interfaceFutureC4260d instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) interfaceFutureC4260d).value;
            if (obj instanceof Cancellation) {
        ...
        if (z9 | (obj instanceof SetFuture)) {
            ...
            while (true) {
                if (ATOMIC_HELPER.casValue(abstractFuture, obj, cancellation)) {
                    ...
                    if (interfaceFutureC4260d instanceof AbstractFuture) {
                        abstractFuture = (AbstractFuture) interfaceFutureC4260d;
