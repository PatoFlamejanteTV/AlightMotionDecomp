...
public class WorkerWrapper implements Runnable {
    ...
    public /* synthetic */ void lambda$runWorker$0(InterfaceFutureC4260d interfaceFutureC4260d) {
        if (this.mWorkerResultFuture.isCancelled()) {
            interfaceFutureC4260d.cancel(true);
        }
    }
    ...
    private void runWorker() {
        ...
        try {
            ...
            if (trySetRunning()) {
                ...
                final InterfaceFutureC4260d future = workForegroundRunnable.getFuture();
    ...
    @NonNull
    public InterfaceFutureC4260d getFuture() {
        return this.mFuture;
    }
