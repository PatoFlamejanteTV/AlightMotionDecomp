...
public abstract class ListenableWorker {
    ...
    @NonNull
    public InterfaceFutureC4260d getForegroundInfoAsync() {
    ...
    @NonNull
    public final InterfaceFutureC4260d setForegroundAsync(@NonNull ForegroundInfo foregroundInfo) {
        return this.mWorkerParams.getForegroundUpdater().setForegroundAsync(getApplicationContext(), getId(), foregroundInfo);
    }

    @NonNull
    public InterfaceFutureC4260d setProgressAsync(@NonNull Data data) {
    ...
    @NonNull
    @MainThread
    public abstract InterfaceFutureC4260d startWork();
