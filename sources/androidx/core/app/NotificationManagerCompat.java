...
public final class NotificationManagerCompat {
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private void handleServiceConnected(ComponentName componentName, IBinder iBinder) {
            ListenerRecord listenerRecord = this.mRecordMap.get(componentName);
            if (listenerRecord != null) {
                listenerRecord.service = a.AbstractBinderC0289a.asInterface(iBinder);
                listenerRecord.retryCount = 0;
                processListenerQueue(listenerRecord);
            }
        }
    ...
    public void deleteUnlistedNotificationChannels(@NonNull Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel a9 = i.a(it.next());
                if (!collection.contains(Api26Impl.getId(a9)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(a9)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(a9));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(@NonNull String str) {
        ...
        if (i8 >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup a9 = r.a(it.next());
                if (Api26Impl.getId(a9).equals(str)) {
                    return a9;
                }
            }
        }
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(a9));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(a9, notificationChannels));
                    }
                }
                return arrayList;
            }
