...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(@Nullable SpinnerAdapter spinnerAdapter, @Nullable Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && AbstractC1706v.a(spinnerAdapter)) {
                    Api23Impl.setDropDownViewTheme(AbstractC1707w.a(spinnerAdapter), theme);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x0064, code lost:            if (r11 == null) goto L31;     */
