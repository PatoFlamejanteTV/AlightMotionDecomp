...
public final class FragmentStrictMode {
    ...
    public static final class Policy {
        ...
        public Policy(Set<? extends Flag> flags, OnViolationListener onViolationListener, Map<String, ? extends Set<Class<? extends Violation>>> allowedViolations) {
            ...
            AbstractC3292y.i(allowedViolations, "allowedViolations");
            this.flags = flags;
        ...
        public static final class Builder {
            ...
            public final Builder allowViolation(Class<? extends Fragment> fragmentClass, Class<? extends Violation> violationClass) {
                AbstractC3292y.i(fragmentClass, "fragmentClass");
                AbstractC3292y.i(violationClass, "violationClass");
                String fragmentClassString = fragmentClass.getName();
                AbstractC3292y.h(fragmentClassString, "fragmentClassString");
    ...
    private final Policy getNearestPolicy(Fragment fragment) {
        while (fragment != null) {
            if (fragment.isAdded()) {
                ...
                AbstractC3292y.h(parentFragmentManager, "declaringFragment.parentFragmentManager");
                if (parentFragmentManager.getStrictModePolicy() != null) {
                    Policy strictModePolicy = parentFragmentManager.getStrictModePolicy();
                    AbstractC3292y.f(strictModePolicy);
    ...
    public static final void handlePolicyViolation$lambda$0(Policy policy, Violation violation) {
        AbstractC3292y.i(policy, "$policy");
        AbstractC3292y.i(violation, "$violation");
    ...
    public static final void onFragmentReuse(Fragment fragment, String previousFragmentId) {
        ...
        AbstractC3292y.i(previousFragmentId, "previousFragmentId");
    ...
    public static final void onSetTargetFragmentUsage(Fragment violatingFragment, Fragment targetFragment, int i8) {
        AbstractC3292y.i(violatingFragment, "violatingFragment");
        AbstractC3292y.i(targetFragment, "targetFragment");
    ...
    public static final void onWrongNestedHierarchy(Fragment fragment, Fragment expectedParentFragment, int i8) {
        AbstractC3292y.i(fragment, "fragment");
        AbstractC3292y.i(expectedParentFragment, "expectedParentFragment");
    ...
    private final void runOnHostThread(Fragment fragment, Runnable runnable) {
        if (fragment.isAdded()) {
            ...
            AbstractC3292y.h(handler, "fragment.parentFragmentManager.host.handler");
            if (AbstractC3292y.d(handler.getLooper(), Looper.myLooper())) {
                runnable.run();
                return;
            } else {
    ...
    private final boolean shouldHandlePolicyViolation(Policy policy, Class<? extends Fragment> cls, Class<? extends Violation> cls2) {
        ...
        if (!AbstractC3292y.d(cls2.getSuperclass(), Violation.class) && AbstractC1435t.d0(set, cls2.getSuperclass())) {
            return false;
        }
