...
abstract class c {
    ...
    public static a a(ECParameterSpec eCParameterSpec) {
        ...
        ECParameterSpec eCParameterSpec2 = f10446a;
        ...
        ECParameterSpec eCParameterSpec3 = f10447b;
        ...
        ECParameterSpec eCParameterSpec4 = f10448c;
        ...
        ECParameterSpec eCParameterSpec5 = f10449d;
    ...
    public static ECParameterSpec b(a aVar) {
        if (a.f10414d.equals(aVar)) {
            return f10446a;
        }
        if (a.f10415e.equals(aVar)) {
            return f10447b;
        }
        if (a.f10417g.equals(aVar)) {
            return f10448c;
        }
        if (a.f10418h.equals(aVar)) {
            return f10449d;
        }
        return null;
    }
