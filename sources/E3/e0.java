...
final class e0 implements InterfaceC2756h.c {

    /* renamed from: a, reason: collision with root package name */
    public static final e0 f31622a = new e0();
    ...
    public List a(C2752d metadata, H0 sharedDataSpec, C2028h transformSpecToElements) {
        ...
        r4.G g8 = null;
        byte b9 = 0;
        if (d0.f31616a.c(metadata)) {
            m8 = AbstractC1435t.e(new j4.u0(g8, g4.n.f32439y0, 1, (AbstractC3284p) (b9 == true ? 1 : 0)));
        } else {
            m8 = AbstractC1435t.m();
        }
    ...
    public C2027g h(H0 sharedDataSpec) {
        AbstractC3292y.i(sharedDataSpec, "sharedDataSpec");
        return new C2027g(d0.f31616a, sharedDataSpec, g4.n.f32415m0, g4.k.f32322C, false, null, 48, null);
    }
