...
final class C2801j implements InterfaceC2756h.c {

    /* renamed from: a, reason: collision with root package name */
    public static final C2801j f31639a = new C2801j();
    ...
    public List a(C2752d metadata, H0 sharedDataSpec, C2028h transformSpecToElements) {
        ...
        r4.G g8 = null;
        byte b9 = 0;
        if (C2800i.f31635a.c(metadata)) {
            m8 = AbstractC1435t.e(new j4.u0(g8, g4.n.f32392b, 1, (AbstractC3284p) (b9 == true ? 1 : 0)));
        } else {
            m8 = AbstractC1435t.m();
        }
    ...
    public C2027g h(H0 sharedDataSpec) {
        AbstractC3292y.i(sharedDataSpec, "sharedDataSpec");
        return new C2027g(C2800i.f31635a, sharedDataSpec, g4.n.f32379P, g4.k.f32340i, false, null, 48, null);
    }
