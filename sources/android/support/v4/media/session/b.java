...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        /* loaded from: classes.dex */
        private static class C0295a implements b {

            /* renamed from: a, reason: collision with root package name */
            private IBinder f14330a;

            C0295a(IBinder iBinder) {
                this.f14330a = iBinder;
            }
            ...
            public void G(android.support.v4.media.session.a aVar) {
                ...
                try {
                    ...
                    this.f14330a.transact(4, obtain, obtain2, 0);
            ...
            public PlaybackStateCompat getPlaybackState() {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
                    this.f14330a.transact(28, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void o(android.support.v4.media.session.a aVar) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(iBinder);
                    this.f14330a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                    obtain2.recycle();
                    obtain.recycle();
                } catch (Throwable th) {
